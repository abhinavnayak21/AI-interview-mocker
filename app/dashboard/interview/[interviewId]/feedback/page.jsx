...
function Feedback({params}) {
  ...
  return (
    <div className='p-10'>
        ...
        <h2 className='font-bold text-2xl'>Here is interview feedback</h2>

        <h2 className='text-primary tetx-lg my-3'>Your overall interview rating: <strong>7/10</strong></h2>
